...
!!!!!!!!!!!!!!!!!! NOTE !!!!!!!!!!!!!!!!!!
The imaginary component of each data-point is non-zero, unlike the "zero_travel" version.

In fact the imaginary component of each forward/back is -0.5 * real_counterpart
'''
