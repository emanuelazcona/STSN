...
fileName = 'non_zero_data/scatter' + userScatter + '_T' + userTime + '_tc20_all_'
...
with tf.Session(config=tf.ConfigProto(gpu_options=tf.GPUOptions(allow_growth=True))) as sess:
	...
	for i in range(1, epochs+1):
		...
		fileFolder = "results/non_zero/n" + userScatter + "_T" + userTime + "_tc20_" + "_Mask_" + str(start) + "_" + str(end) + "_lr{0:.3f}".format(lr)
